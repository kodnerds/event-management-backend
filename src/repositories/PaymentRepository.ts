...
import { PaymentEntity, PaymentProvider, PaymentStatus, type RsvpEntity, type ShowEntity, type UserEntity } from "../entities";
...
export class PaymentRepository {
    ...
    async createPayment(user: UserEntity, shows: ShowEntity, rsvp: RsvpEntity, reference: string): Promise<PaymentEntity> {
